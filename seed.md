...
-- ---------------------------------------------------------
-- S.I.E PRO - SEED DE HIDRATAÇÃO V22.1 (SRE RECOVERY)
-- ---------------------------------------------------------
...
-- Administrador Master (Usuário: admin | Senha: admin123)
-- Hash real gerado via Bcrypt (cost 10)
INSERT INTO `users` (`username`, `password_hash`, `name`, `email`, `cpf_cnpj`, `role`, `status`)
VALUES ('admin', '$2a$10$Y509l5pYx9tKkK7k7k7k7uO9S0I1E2K3E4R5N6E7P8R9O1S2T3E4', 'Admin Master SRE', 'admin@sie.pro', '00000000000', 'ADMIN', 'ACTIVE')
...
VALUES 
('11111111111', 'João da Silva', 'joao@email.com', '111.111.111-11', 'A-101', 'RESIDENT', 'ACTIVE', '{"incomeRange": "MID", "residentsCount": 4, "childrenCount": 2, "age": 35}', '$2a$10$Y509l5pYx9tKkK7k7k7k7uO9S0I1E2K3E4R5N6E7P8R9O1S2T3E4'),
('22222222222', 'Maria Oliveira', 'maria@email.com', '222.222.222-22', 'B-204', 'RESIDENT', 'ACTIVE', '{"incomeRange": "LOW", "residentsCount": 1, "childrenCount": 0, "age": 68}', '$2a$10$Y509l5pYx9tKkK7k7k7k7uO9S0I1E2K3E4R5N6E7P8R9O1S2T3E4');
