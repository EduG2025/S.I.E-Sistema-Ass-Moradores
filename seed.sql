...
-- ---------------------------------------------------------
-- S.I.E PRO - SEED DE HIDRATAÇÃO INICIAL V350.0
-- ---------------------------------------------------------
...
-- 3. MORADORES DE EXEMPLO
INSERT INTO `users` 
(`name`, `cpf_cnpj`, `email`, `role`, `status`, `active`, `unit`, `phone`, `socialData`, `coordinates`) 
VALUES 
('Carlos Silva', '11122233344', 'carlos@exemplo.com', 'RESIDENT', 'ACTIVE', 1, 'APTO 101', '11988887777', '{"risk": 15, "tags": ["PAGO_EM_DIA"]}', '{"lat": -23.5510, "lng": -46.6340}'),
('Maria Oliveira', '55566677788', 'maria@exemplo.com', 'RESIDENT', 'ACTIVE', 1, 'CASA 42', '11977776666', '{"risk": 75, "tags": ["ALTO_RISCO"]}', '{"lat": -23.5500, "lng": -46.6320}');
...
-- 5. LANÇAMENTOS FINANCEIROS PARA GRÁFICOS
INSERT INTO `financials` 
(`description`, `amount`, `type`, `category`, `status`, `date`) 
VALUES 
('Arrecadação Condominial Jan/2025', 15000.00, 'INCOME', 'CONDOMÍNIO', 'PAID', '2025-01-10'),
('Manutenção de Elevadores', 2500.00, 'EXPENSE', 'MANUTENÇÃO', 'PAID', '2025-01-15');

-- 6. AGENDA DE MARCOS
INSERT INTO `agenda` 
(`title`, `description`, `date`, `type`, `status`) 
VALUES 
('Assembleia Geral Ordinária', 'Prestação de contas e eleição do novo conselho.', '2025-06-15 19:00:00', 'MEETING', 'SCHEDULED');

SELECT '✅ HIDRATAÇÃO KERNEL S.I.E CONCLUÍDA' as STATUS;
